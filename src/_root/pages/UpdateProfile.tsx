...
import { ProfileValidations } from "@/lib/validation";
...
const UpdateProfile = () => {
  ...
  const form = useForm<z.infer<typeof ProfileValidations>>({
    resolver: zodResolver(ProfileValidations),
    defaultValues: {
      file: [],
      name: user.name,
  ...
  // Handler
  const handleUpdate = async (value: z.infer<typeof ProfileValidations>) => {
